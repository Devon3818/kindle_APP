angular.module('App')
	.controller('BabyWeightCtrl', function($scope, $ionicPopup, $http, $ionicLoading, $rootScope, $cordovaToast) {
		...
		$scope.decoding = function(value) {
			...
			var bases64 = bases.fromBase(value, '64'),
				...
				str2 = bases.fromBase(str, '16'),
				str3 = bases.toBase(str2, 10),
				Result = (parseInt(str3)) / 1000;
